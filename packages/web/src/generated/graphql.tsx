...
export type ReturnRequest = {
  ...
  returnReason: Scalars['Int'];
  returnReasonComment: Scalars['String'];
...
export type Query = {
  ...
  allReturnRequests: Array<ReturnRequest>;
...
export type CreateReturnRequestMutation = (
  ...
  & { createReturnRequest: (
    { __typename?: 'ReturnRequest' }
    & Pick<ReturnRequest, 'serialNumber' | 'invoiceNumber' | 'returnReason' | 'returnReasonComment' | 'comment'>
  ) }
);
...
export type AllReturnRequestsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllReturnRequestsQuery = (
  { __typename?: 'Query' }
  & { allReturnRequests: Array<(
    { __typename?: 'ReturnRequest' }
    & Pick<ReturnRequest, 'id' | 'serialNumber' | 'invoiceNumber' | 'returnReason' | 'returnReasonComment' | 'comment' | 'createdAt'>
  )> }
);
...
export type OrderQuery = (
  ...
  & { order: (
    { __typename?: 'Order' }
    & Pick<Order, 'id' | 'invoiceNumber' | 'total' | 'state'>
    & { order: Array<(
      { __typename?: 'OrderProduct' }
      & Pick<OrderProduct, 'id' | 'quantity'>
      & { product: (
...
export type ReturnRequestQueryVariables = Exact<{
  id: Scalars['ID'];
}>;
...
export type ReturnRequestQuery = (
  ...
  & { returnRequest: (
    { __typename?: 'ReturnRequest' }
    & Pick<ReturnRequest, 'id' | 'serialNumber' | 'invoiceNumber' | 'returnReason' | 'returnReasonComment' | 'comment'>
  ) }
);
...
export function useCreateReturnRequestMutation() {
  return Urql.useMutation<CreateReturnRequestMutation, CreateReturnRequestMutationVariables>(CreateReturnRequestDocument);
};
...
export const AllReturnRequestsDocument = gql`
    query AllReturnRequests {
  allReturnRequests {
    id
    serialNumber
    invoiceNumber
...
export function useAllReturnRequestsQuery(options: Omit<Urql.UseQueryArgs<AllReturnRequestsQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<AllReturnRequestsQuery>({ query: AllReturnRequestsDocument, ...options });
};
...
export const ReturnRequestDocument = gql`
    query ReturnRequest($id: ID!) {
  returnRequest(id: $id) {
    id
    serialNumber
    invoiceNumber
...
export function useReturnRequestQuery(options: Omit<Urql.UseQueryArgs<ReturnRequestQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<ReturnRequestQuery>({ query: ReturnRequestDocument, ...options });
};
