    ...
    >
      {props => (
        <Form formik={props}>
          ...
          />
          <FieldError id='name' label='Name' formik={props} />
          <FieldError id='lastName' label='Last Name' formik={props} />
          <FieldError id='company' label='Company' formik={props} />
          <FieldError id='email' label='Email' type='email' formik={props} />
          <FieldError id='phone' label='Phone' type='tel' formik={props} />
